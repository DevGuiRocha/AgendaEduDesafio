...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { fornecedor: @despesa.fornecedor, numero_doc: @despesa.numero_doc } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { fornecedor: @despesa.fornecedor, numero_doc: @despesa.numero_doc } }
